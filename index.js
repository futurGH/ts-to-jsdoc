 ...
 * @returns {string} Transpiled code (or the original source code if something went wrong)
 */
module.exports = function transpile(src, filename, compilerOptions = {}) {
	try {
